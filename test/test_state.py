...
class StateTestCase(unittest.TestCase):
    ...
    def test_template_dir(self):
        ...
        self.assertEqual(pathlib.Path('~/Templates').expanduser().resolve(),
    ...
    def test_debug(self):
        ...
        self.assertEqual(False, self.state.debug)
    ...
    def test_login(self):
        ...
        self.assertEqual(True, self.state.login)
    ...
    def test_https_proxy(self):
        self.assertEqual(str, type(self.state.https_proxy))
        self.assertEqual(None, self.state._https_proxy)
        self.assertEqual('http://localhost:8080', self.state.https_proxy)
    ...
    def test_api_token(self):
        ...
        self.assertEqual('12345', self.state._api_token)
        self.assertEqual('12345', self.state.api_token)

    def test_notifications_token(self):
        self.assertEqual(str, type(self.state.notifications_token))
        self.assertEqual(None, self.state._notifications_token)
        self.assertEqual('', self.state.notifications_token)
        self.state.notifications_token = '12345'
        self.assertEqual('12345', self.state._notifications_token)
        self.assertEqual('12345', self.state.notifications_token)

    def test_otp_secret(self):
        self.assertEqual(str, type(self.state.otp_secret))
        self.assertEqual(None, self.state._otp_secret)
        self.assertEqual('', self.state.otp_secret)
        self.state.otp_secret = '12345'
        self.assertEqual('12345', self.state._otp_secret)
        self.assertEqual('12345', self.state.otp_secret)

    def test_email(self):
        self.assertEqual(str, type(self.state.email))
    ...
    def test_password(self):
        self.assertEqual(str, type(self.state.password))
    ...
    def test_user_id(self):
        self.assertEqual(str, type(self.state.user_id))
        self.assertEqual(None, self.state._user_id)
        self.assertEqual('', self.state.user_id)
