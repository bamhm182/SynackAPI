...
class StateTestCase(unittest.TestCase):
    ...
    def test_duo_akey(self):
        self.assertEqual(self.state._db.duo_akey, self.state.duo_akey)
        self.assertEqual(None, self.state._duo_akey)
        self.state.duo_akey = 'akey'
        self.assertEqual('akey', self.state.duo_akey)
        self.assertEqual('akey', self.state._duo_akey)

    def test_duo_host(self):
        self.assertEqual(self.state._db.duo_host, self.state.duo_host)
        self.assertEqual(None, self.state._duo_host)
        self.state.duo_host = 'api.duo.com'
        self.assertEqual('api.duo.com', self.state.duo_host)
        self.assertEqual('api.duo.com', self.state._duo_host)

    def test_duo_pkey(self):
        self.assertEqual(self.state._db.duo_pkey, self.state.duo_pkey)
        self.assertEqual(None, self.state._duo_pkey)
        self.state.duo_pkey = 'pkey'
        self.assertEqual('pkey', self.state.duo_pkey)
        self.assertEqual('pkey', self.state._duo_pkey)

    def test_duo_rsa_key(self):
        self.assertEqual(self.state._db.duo_rsa_key, self.state.duo_rsa_key)
        self.assertEqual(None, self.state._duo_rsa_key)
        self.state.duo_rsa_key = 'pem'
        self.assertEqual('pem', self.state.duo_rsa_key)
        self.assertEqual('pem', self.state._duo_rsa_key)
