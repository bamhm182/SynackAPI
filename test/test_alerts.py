...
class AlertsTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.alerts._db = MagicMock()

    def test_email_no_tls(self):
        """Should send a non-TLS encrypted email"""
        self.alerts._state.smtp_starttls = False
        self.alerts._state.smtp_server = 'smtp.email.com'
        self.alerts._state.smtp_port = 587
        self.alerts._state.smtp_username = 'user5'
        self.alerts._state.smtp_password = 'password123'
    ...
    def test_email_tls(self):
        ...
        self.alerts._state.smtp_starttls = True
        self.alerts._state.smtp_server = 'smtp.email.com'
        self.alerts._state.smtp_port = 465
        self.alerts._state.smtp_username = 'user5'
        self.alerts._state.smtp_password = 'password123'
    ...
    def test_slack(self):
        ...
        with patch('requests.post') as mock_post:
            self.alerts._state.slack_channel = 'myslackchannel'
            self.alerts._state.slack_app_token = '1234'
            self.alerts.slack('this is a test')
            mock_post.assert_called_with('https://slack.com/api/chat.postMessage',
                                         data='{"text": "this is a test", "channel": "myslackchannel"}',
                                         headers={
