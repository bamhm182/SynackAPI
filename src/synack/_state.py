...
class State(object):
    ...
    @property
    def duo_akey(self) -> str:
        ret = self._duo_akey
        if ret is None:
            ret = self._db.duo_akey
        return ret

    @duo_akey.setter
    def duo_akey(self, value: str) -> None:
        self._duo_akey = value

    @property
    def duo_host(self) -> str:
        ret = self._duo_host
        if ret is None:
            ret = self._db.duo_host
        return ret

    @duo_host.setter
    def duo_host(self, value: str) -> None:
        self._duo_host = value

    @property
    def duo_pkey(self) -> str:
        ret = self._duo_pkey
        if ret is None:
            ret = self._db.duo_pkey
        return ret

    @duo_pkey.setter
    def duo_pkey(self, value: str) -> None:
        self._duo_pkey = value

    @property
    def duo_rsa_key(self) -> str:
        ret = self._duo_rsa_key
        if ret is None:
            ret = self._db.duo_rsa_key
        return ret

    @duo_rsa_key.setter
    def duo_rsa_key(self, value: str) -> None:
        self._duo_rsa_key = value
